...
namespace winrt::impl
{
    ...
    {
        WINRT_IMPL_SHIM(winrt::Windows::Media::ClosedCaptioning::IClosedCaptionThemeStatics)->remove_ThemesChanged(impl::bind_in(token));
    }
    ...
    {
        WINRT_IMPL_SHIM(winrt::Windows::Media::ClosedCaptioning::IClosedCaptionThemeStatics)->remove_SelectedThemeChanged(impl::bind_in(token));
    }
